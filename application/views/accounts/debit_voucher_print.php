...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
	...
	<link href="<?php echo base_url();?>assets/css/style-pdf.css" rel="stylesheet" />
							...
							<table border="0" style="border-collapse:collapse;" class="table table-striped table-bordered" cellspacing="0" width="100%">
								<tr>
									<td style="width:33%; text-align:left;">
										...
										<?php echo $debit_voucher_row_edit["voucher_no"];?>
									</td>
									<td style="width:33%;"></td>
									<td style="width:33%; text-align:right;">
										<label><b>Date: </b></label>
										<?php echo $debit_voucher_row_edit["current_date"];?>
									</td>
								</tr>
								<tr>
									<td>
										<label><b><?php if($debit_voucher_row_edit["pay_status"]=="pay_to"){echo "Pay To :";}else{ echo "Pay By :";}?> </b></label>
										<?php echo $debit_voucher_row_edit["pay_name"];?>
									</td>
									<td></td>
									<td></td>
								</tr>
								<tr>
									<td>
										...
										<?php echo $debit_voucher_row_edit["purpose"];?>
									</td>
									<td></td>
									<td></td>
								</tr>
							...
							<table border="1" style="border-collapse:collapse;" class="table table-striped table-bordered" id='area' cellspacing="0" width="100%">
								...
								<tr>
									...
									<td style='text-align:right;'>
										<?php echo number_format($debit_voucher_row_edit["debit_sum"],2);?>
									</td>
									<td style='text-align:right;'>
										<?php echo number_format($debit_voucher_row_edit["credit_sum"],2);?>
									</td>
								</tr>
							</table>
						</div>
						...
						<table border="0" style="border-collapse:collapse;" class="table table-striped table-bordered" cellspacing="0" width="100%">
							<tr>
								<td style="width:33%; text-align:left;">
									...
									<?php echo $debit_voucher_row_edit["cheque_no"];?>
								</td>
								<td style="width:33%; text-align:left;">
									<label><b>Cheque Date:</b></label>
									<?php 
									$cheque_dtArr=explode("-",$debit_voucher_row_edit["cheque_dt"]);
									if($cheque_dtArr[0]>0) 
										echo $debit_voucher_row_edit["cheque_dt"];
									?>
								</td>
								<td style="width:33%; text-align:left;">
									<label><b>Bank:</b></label>
									<?php echo $debit_voucher_row_edit["bank"];?>
								</td>
							</tr>
						</table>		
						</div>
