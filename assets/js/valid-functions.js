...
$.getJSON( baseUrl+'accounts/get_check_account_code',{'code':code,'increment':increment}, function(j){
	if(j.length>0){
		...
		$('#account_code_suggestions_'+increment).css({"z-index": "99999", "position": "absolute" ,"left":"-1px","right":"10px"});
	...
	else
	{
		...
		$('#account_code_suggestions_'+increment).css({"z-index": "99999", "position": "absolute" ,"left":"-1px","right":"0px"});
